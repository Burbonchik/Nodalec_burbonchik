...
/obj/item/gun/ballistic/automatic/pistol/commissar
	...
	icon = 'icons/obj/weapons/guns/manufacturer/nanotrasen_sharplite/48x32.dmi'
	lefthand_file = 'icons/obj/weapons/guns/manufacturer/nanotrasen_sharplite/lefthand.dmi'
	righthand_file = 'icons/obj/weapons/guns/manufacturer/nanotrasen_sharplite/righthand.dmi'
	mob_overlay_icon = 'icons/obj/weapons/guns/manufacturer/nanotrasen_sharplite/onmob.dmi'
